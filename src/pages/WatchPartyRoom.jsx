      ...
      <div className={`flex-1 flex flex-col ${showChat ? 'mr-80' : ''} transition-all`}>
        ...
        <div className="h-14 bg-black/80 backdrop-blur-xl flex items-center justify-between px-4 border-b border-white/10">
          ...
          <div className="flex items-center gap-2">
            <button onClick={copyInvite} className="flex items-center gap-2 px-3 py-1.5 bg-cyan-500/20 text-cyan-400 rounded-lg hover:bg-cyan-500/30">
              ...
              {chatMessages.map(msg => (
                <div key={msg.id}>
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-cyan-400 text-sm font-medium">{msg.sender_name}</span>
